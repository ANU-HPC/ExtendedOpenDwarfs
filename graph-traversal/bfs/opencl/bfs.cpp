...
void BFSGraph(int argc, char ** argv)
{
    ...
    LSB_Set_Rparam_string("region", "host_input_setup");
    LSB_Res();
...
*/
    ...
    LSB_Set_Rparam_string("region", "program_build");
    LSB_Res();
	char* kernel_files;
	int num_kernels = 20;
    ...
    do {
        ...
        do
        {
            ...
            LSB_Set_Rparam_string("region", "kernel1_execution");
            LSB_Res();
            ...
            LSB_Set_Rparam_string("region", "kernel2_execution");
            LSB_Res();
	...
	free(h_cost);
    LSB_Set_Rparam_string("region", "kernel_cleanup");
    LSB_Res();
