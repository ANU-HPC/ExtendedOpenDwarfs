...
runTest( int argc, char** argv) 
{
    ...
    LSB_Set_Rparam_int("rows", 0);
    LSB_Set_Rparam_int("cols", 0);
    LSB_Set_Rparam_int("niter", 0);
...
*/    
    ...
    const char* kernel_files = "srad_kernel";
        
    clProgram=ocdBuildProgramFromFile(context,device_id,(char*)kernel_files, NULL);
