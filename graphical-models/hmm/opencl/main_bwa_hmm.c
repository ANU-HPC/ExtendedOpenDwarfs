...
float dot_production(int n, cl_mem paramA, int offsetA, cl_mem paramB, int offsetB)
{
    ...
    LSB_Set_Rparam_string("region", "setting_dot_kernel_arguments");
    LSB_Res();
    ...
    LSB_Set_Rparam_string("region", "dot_kernel_execution");
    LSB_Res();
	...
	clReleaseMemObject(partialSum_d);
	free(partialSum);
...
void mat_vec_mul(char trans, int m, int n, cl_mem A, int lda, cl_mem x, int offsetX, cl_mem y, int offsetY)
{
	...
	if(trans == 't')
	{
		 ...
		 */
        LSB_Set_Rparam_string("region", "setting_matvec_kernel_arguments");
        LSB_Res();
        ...
        LSB_Set_Rparam_string("region", "matvec_kernel_execution");
        LSB_Res();
...
float calc_alpha()
{
	...
	//                                                 ones_n_d,
	//                                                 obs[0]);
    LSB_Set_Rparam_string("region", "setting_alpha_kernel_arguments");
    LSB_Res();
    ...
    LSB_Set_Rparam_string("region", "alpha_kernel_execution");
    LSB_Res();
...
int calc_beta()
{
    ...
    LSB_Set_Rparam_string("region", "setting_beta_kernel_arguments");
    LSB_Res();
    ...
    LSB_Set_Rparam_string("region", "beta_kernel_execution");
    LSB_Res();
...
void calc_gamma_sum()
{
	...
	for (t = 0; t < length; t++) {
		...
		// nstates,
		// t);
        LSB_Set_Rparam_string("region", "setting_gamma_kernel_arguments");
        LSB_Res();
        ...
        LSB_Set_Rparam_string("region", "gamma_kernel_execution");
        LSB_Res();
...
int calc_xi_sum()
{
	...
	for (t = 0; t < length - 1; t++) {
		...
		// obs[t+1],
		// t);
        LSB_Set_Rparam_string("region", "setting_xi_kernel_arguments");
        LSB_Res();
        ...
        LSB_Set_Rparam_string("region", "xi_kernel_execution");
        LSB_Res();
...
int estimate_a()
{
	...
	// nstates,
	// length);
    LSB_Set_Rparam_string("region", "setting_estimate_a_kernel_arguments");
    LSB_Res();
    ...
    LSB_Set_Rparam_string("region", "estimate_a_kernel_execution");
    LSB_Res();
...
int estimate_b()
{
	...
	for (t = 0; t < length; t++) {
		...
		// obs[t], 
		// t);
        LSB_Set_Rparam_string("region", "setting_estimate_b_kernel_arguments");
        LSB_Res();
        ...
        LSB_Set_Rparam_string("region", "estimate_b_kernel_execution");
        LSB_Res();
...
int estimate_pi()
{
	...
	// sum_ab, 
	// nstates);
    LSB_Set_Rparam_string("region", "setting_estimate_pi_kernel_arguments");
    LSB_Res();
    ...
    LSB_Set_Rparam_string("region", "estimate_pi_kernel_execution");
    LSB_Res();
		...
		float threshold)
{
    ...
    do {
        ...
        LSB_Set_Rparam_string("region", "setting_init_kernel_arguments");
        LSB_Res();
        ...
        LSB_Set_Rparam_string("region", "init_kernel_execution");
        LSB_Res();
